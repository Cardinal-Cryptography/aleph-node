use crate::{
    aggregator::SignableHash, crypto::Signature, new_network::data_network::split::DataNetwork,
    Error,
};
...
impl<B: BlockT> RmcNetwork<B> {
    ...
    pub(crate) fn send(&self, data: RmcNetworkData<B>, recipient: Recipient) -> Result<(), Error> {
