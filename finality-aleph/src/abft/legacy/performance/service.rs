...
use legacy_aleph_bft::NodeCount;
...
use crate::{
    abft::{
        legacy::performance::{scorer::Scorer, Batch},
        LOG_TARGET,
    },
    aleph_primitives::{
...
where
    UH: UnverifiedHeader,
    FH: legacy_aleph_bft::FinalizationHandler<AlephData<UH>>,
{
...
impl<UH, FH> legacy_aleph_bft::UnitFinalizationHandler for FinalizationWrapper<UH, FH>
where
    UH: UnverifiedHeader,
    FH: legacy_aleph_bft::FinalizationHandler<AlephData<UH>>,
{
    ...
    RA: RuntimeApi,
{
    ...
    pub fn new<FH>(
        ...
        Self,
        impl legacy_aleph_bft::UnitFinalizationHandler<Data = AlephData<UH>, Hasher = Hasher>,
    )
    where
        FH: legacy_aleph_bft::FinalizationHandler<AlephData<UH>>,
    {
