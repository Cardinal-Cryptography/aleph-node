...
impl<BI: BlockIdentifier> LegacyVerifier<BI> for SessionVerifier {
    fn verify(&self, justification: &AlephJustification, hash: BI::Hash) -> bool {
