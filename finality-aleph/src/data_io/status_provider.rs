...
mod tests {
    ...
    fn proposal_from_headers(headers: Vec<MockHeader>) -> AlephProposal<MockHeader> {
    ...
    fn proposal_from_blocks(blocks: Vec<MockBlock>) -> AlephProposal<MockHeader> {
    ...
    fn verify_proposal_status(
        ...
        proposal: &AlephProposal<MockHeader>,
