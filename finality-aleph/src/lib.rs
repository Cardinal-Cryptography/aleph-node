...
use sc_network::config::{MultiaddrWithPeerId, NonDefaultSetConfig, SetConfig, NonReservedPeerMode};
...
pub fn peers_set_config(reserved_nodes: Vec<MultiaddrWithPeerId>) -> NonDefaultSetConfig {
    NonDefaultSetConfig {
