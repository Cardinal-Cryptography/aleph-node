...
```
sudo DOCKER_BUILDKIT=1 BUILDKIT_PROGRESS=plain BUILDKIT_STEP_LOG_MAX_SIZE=-1
BUILDKIT_STEP_LOG_MAX_SPEED=-1 docker build -t aleph-node/build -f nix/Dockerfile.build .
