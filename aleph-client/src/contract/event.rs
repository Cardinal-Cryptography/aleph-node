...
///
/// let tx_info = contract.exec_api().exec0(&signed_conn, "some_method").await?;
///
...
///
/// contract1.exec_api().exec0(&signed_conn, "some_method").await?;
/// contract2.exec_api().exec0(&signed_conn, "some_other_method").await?;
///
