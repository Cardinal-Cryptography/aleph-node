...
pub mod api {
            ...
            impl StorageApi {
                ...
                > {
                    ::subxt::storage::address::StaticStorageAddress::new(
                        ...
                        vec![],
                        [
                            147u8, 138u8, 222u8, 78u8, 186u8, 222u8, 5u8, 63u8, 191u8, 185u8, 70u8,
                            232u8, 212u8, 60u8, 240u8, 183u8, 192u8, 156u8, 250u8, 142u8, 177u8,
                            242u8, 29u8, 140u8, 109u8, 53u8, 203u8, 218u8, 101u8, 92u8, 54u8,
                            165u8,
                        ],
                    )
                }
    ...
    pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
        ...
        if runtime_metadata_hash
            != [
                139u8, 103u8, 142u8, 142u8, 97u8, 175u8, 137u8, 174u8, 25u8, 144u8, 54u8, 75u8,
                16u8, 12u8, 100u8, 231u8, 195u8, 119u8, 91u8, 146u8, 198u8, 97u8, 191u8, 42u8,
                45u8, 80u8, 104u8, 133u8, 7u8, 120u8, 9u8, 79u8,
            ]
        {
