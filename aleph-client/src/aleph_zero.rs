...
pub mod api {
            ...
            impl StorageApi {
                ...
                > {
                    ::subxt::storage::address::StaticStorageAddress::new(
                        ...
                        vec![],
                        [
                            75u8, 252u8, 57u8, 255u8, 14u8, 139u8, 122u8, 231u8, 122u8, 164u8, 6u8,
                            246u8, 200u8, 49u8, 153u8, 7u8, 216u8, 37u8, 68u8, 180u8, 121u8, 18u8,
                            205u8, 19u8, 31u8, 171u8, 90u8, 12u8, 241u8, 99u8, 178u8, 200u8,
                        ],
                    )
                }
    ...
    pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
        ...
        if runtime_metadata_hash
            != [
                207u8, 203u8, 21u8, 116u8, 103u8, 168u8, 147u8, 122u8, 21u8, 59u8, 98u8, 74u8,
                139u8, 55u8, 30u8, 35u8, 182u8, 157u8, 247u8, 33u8, 228u8, 89u8, 233u8, 84u8,
                220u8, 197u8, 228u8, 7u8, 76u8, 100u8, 7u8, 13u8,
            ]
        {
