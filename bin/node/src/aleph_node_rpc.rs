...
use finality_aleph::{AlephJustification, IdentifierFor, JustificationNotification};
...
{
    import_justification_tx: mpsc::UnboundedSender<JustificationNotification<IdentifierFor<B>>>,
}
