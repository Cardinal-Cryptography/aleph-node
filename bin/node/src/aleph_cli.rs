...
pub struct AlephCli {
    ...
    /// Maximum bit-rate per connection in bytes per second of the alephbft validator network.
    #[clap(long, default_value_t = 64 * 1024)]
    alephbft_network_bit_rate_per_connection: u64,

    /// Maximum bit-rate per connection in bytes per second of the substrate network.
    #[clap(long, default_value_t = 64 * 1024)]
    substrate_network_bit_rate_per_connection: u64,
...
impl AlephCli {
    ...
    pub fn alephbft_network_bit_rate_per_connection(&self) -> u64 {
        self.alephbft_network_bit_rate_per_connection
    }

    pub fn substrate_network_bit_rate_per_connection(&self) -> u64 {
        self.substrate_network_bit_rate_per_connection
    }
