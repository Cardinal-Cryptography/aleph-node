...
use primitives::{
    ...
    AuthorityId as AlephId, BlockNumber as AlephBlockNumber, SessionAuthorityData, Version as FinalityVersion,
    ...
    Block as AlephBlock, Header as AlephHeader, BlockId as AlephBlockId,
};
