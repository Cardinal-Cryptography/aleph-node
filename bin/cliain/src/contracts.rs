...
pub async fn upload_code(
    ...
    let connection = signed_connection.as_connection().clone();
...
pub async fn instantiate_with_code(
    ...
    let signer_id = signed_connection.account_id().clone();
    let connection_0 = signed_connection.as_connection().clone();
    let connection_1 = signed_connection.as_connection().clone();
