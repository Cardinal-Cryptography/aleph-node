...
use super::{
    ...
    encode::Encoder,
    env_types::{
        self, CustomTypeDecoder, CustomTypeEncoder, EnvTypesTranscoder, PathKey, TypesByPath,
    },
    scon::Value,
};
...
impl<'a> TranscoderBuilder<'a> {
    ...
    pub fn with_default_custom_type_transcoders(self) -> Self {
        self.register_custom_type_transcoder::<sp_runtime::AccountId32, _>(env_types::AccountId)
