...
./target/release/aleph-node bootstrap-chain --base-path docker/data --chain-id a0dnet1 --n-members 4 --sudo-account-id $DAMIAN --session-period 5 --millisecs-per-block 1000 > docker/data/chainspec.json
